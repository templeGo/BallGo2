...
public class ThrowingScript : MonoBehaviour
{
    ...
    public GameObject[] oneOfTargets;

    //候補からランダムに抽出したものをtargetObjectに
    //public GameObject TargetObject = oneOfTargets[Random.Range(0, oneOfTargets.Length)];
    ...
    {
        GameObject TargetObject = oneOfTargets[Random.Range(0, oneOfTargets.Length)];
